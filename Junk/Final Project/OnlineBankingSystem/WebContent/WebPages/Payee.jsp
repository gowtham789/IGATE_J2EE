...
<br>
<c:if test="${count==0}">
<form action="./getMyPayees" method="post">
<table>
	<tr>
	...
	<tr><td><br></td></tr>
	<tr><td><br></td></tr>
	<tr><td><input type="submit" id="button" value="GetPayee"/></td></tr>
</table>
<br>
</form>
<div align="center"><a href="./AddPayee" >Add Payee</a></div>
<br>
<br>
<a href="fundtransfer" target="right">Go Back </a>
</c:if>
	
<c:if test="${count==1}">
<h2>Your Account and Your Payee Account</h2>
<form action="./fundtrans" method="post">
<table>
	<tr>
	...
	<tr>
		...
		<option value="<c:out value="${pids}"/>"><c:out value="${pids}"/></option>
		</c:forEach>
		</select></td>
	</tr>
	<tr>
