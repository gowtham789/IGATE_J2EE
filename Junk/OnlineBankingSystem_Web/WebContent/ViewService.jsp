								...
								<table>
									...
									<c:forEach items="${service}" var="serv">
										<tr>
												...
												<c:if test="${serv.getAccountId() == AccountNumber}">
													<td>${serv.getAccountId()}</td>
													<td>${serv.getServiceId()}</td>													
													<td>${serv.getServiceRaisedDate()}</td>
													<td>${serv.getServiceStatus()}</td>	
													<td>${serv.getServiceDescription()}</td>	
