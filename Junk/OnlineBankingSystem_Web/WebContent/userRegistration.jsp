						...
						<h3>
						   <form method="post"	action="UserRegistration">
								<table>									
									...
									<tr>
									    <td>Customer Name</td>
										<td><input type="text" name="customerName"></input></td>
									</tr>
									<tr>
									<td>Email</td>
									...
									<td>Login Password</td>
										<td><input type="text" name="loginPassword"></input></td>
									</tr>
									<tr>
									<td>Mobile Number </td>
									...
									<tr>
									<td>Pan Card</td>
										<td><input type="text" name="panCard"></input></td>
									</tr>
									<tr>
									<td>Secret Answer</td>
										<td><input type="text" name="secretAnswer"></input></td>
									</tr>
									<tr>
									<td>Secret Question</td>
										<td><input type="text" name="secretQuestion"></input></td>
									</tr>
									<tr>
									<td>Transaction Password</td>
										<td><input type="text" name="transactionPassword"></input></td>
									</tr>
									<tr>
									<td>User Id</td>
