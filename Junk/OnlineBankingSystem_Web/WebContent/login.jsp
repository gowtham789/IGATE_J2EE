	...
	<div class="page padding-bottom">
		<div class="content_wrap">
			<div class="left-panel">
				<div class="panel">
					<div class="title">
						<h1>IGATE BANKING SERVICES</h1>
					</div>
					<div class="content marbottom30">
						<form method="post" action="Login">
							<h3>
								<div class="row">
									<label>User name</label> <input id="txt_Name" name="txt_Name"
										type="text" />
								</div>
								<div class="row">
									<label>Password</label> <input id="txt_password"
										name="txt_password" type="password" />
								</div>
								<div class="row">
									<table>
										<tr>
											...
											<c:choose>
												<c:when test="${LoginStatus != null && LoginStatus != 'Login Successful'}">
												<tr>      						   												 
												<td>
												<p>${LoginStatus}</p>
												</td>
