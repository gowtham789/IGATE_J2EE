						...
						<h3>
							...
							<form method="post" action="EditPersonalInfo">
								<c:forEach items="${customerInfo}" var="customer">
									<c:if test="${customer.getAccountId() == accountID }">
										<table>
											<tr>
												<td>Account Number :</td>
												<td><input type="text" name="accountID" id="accountID"
													readonly="readonly" value="${accountID}" /></td>
											</tr>
											<tr>
												<td>Address :</td>
												<td><input type="text" name="Address" id="editable"													readonly="readonly" value="${customer.getAddress()}" /></td>
											</tr>
											<tr>
												<td>Name :</td>
												<td><input type="text" name="accountID" id="editable"
													readonly="readonly" value="${customer.getCustomerName()}" />
												</td>
											</tr>
											<tr>
												<td>Email :</td>
												<td><input type="text" name="Email" id="editable"
													 value="${customer.getEmail()}" /></td>
											</tr>
											<tr>
												<td>Mobile Number :</td>
												<td><input type="text" name="MobileNumber" id="editable"
											...
											<tr>
												...
												<td><input type="text" name="accountID" id="editable"
													readonly="readonly" value="${customer.getPancard()}" /></td>
											</tr>
											<tr>
											<td>
