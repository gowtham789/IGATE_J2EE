...
class InterfaceImplementation {
	...
	public static void main(String args[]) {
		...
		/*	
		c is a reference of type Collection pointing to an object of type FIFOqueue class.
		This is possible because FIFOqueue class implements Colloction interface.
		*/
		...
		/* 
		The same opearation is performed on LIFOqueue object. But the results are different, cause
		the way LIFOqueue impements delete method is not exactly same as FIFOqueue class.
		*/
		c = new LIFOqueue();
		for (int i = 0;i < arr.length ;i++) {
			c.add(new Integer(arr[i]));
