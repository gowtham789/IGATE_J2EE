...
<%--  
 ***************************************************************************************
 * Description  :   Presentation Layer(Frames)
 * Functionality: This is a Jsp, which will have all frames related to admin home page
 * Models Used : None
...
<iframe name="left" id="left" src="adminleftpage.obj" height="400px" width="25%" >
</iframe>

<iframe name="right"id="right" src="adminrightpage.obj" height="400px" width="69%" >
</iframe>
