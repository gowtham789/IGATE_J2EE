 ...
 * Functionality: This is a Jsp, which will show a form to accept login credintails of admin
 * Models Used : None
...
<div class="d3">
	<div class="user">
	<c:if test="${admin==1}">
	<h4><font color="red">Please Enter Valid username and Password </font></h4>
	</c:if>
	<c:if test="${exception==1}">
	<h4><font color="red">Problem with database server please try again later</font></h4>
	</c:if>
			<form:form  action="AdminLogin.obj" modelAttribute="adto">
			<table class="table" cellspacing="10" align="center">
				<tr class="uname">
				<td><b>AdminName:</b></td>
				<td><form:input path="adId" required="true" />  </td>
				</tr>

				<tr>
				<td><b>Password:</b></td>
				<td><form:password path="adPwd"  required="true"/>  </td>
				</tr>
			    <tr></tr>
				<tr>
